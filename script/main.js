...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function changeLanguage(lang) {
        ...
        // Attendre que Google Translate soit bien chargé et que le ruban apparaisse
        setTimeout(() => {
            const googleBanner = document.querySelector(".goog-te-banner-frame");
            if (googleBanner) {
                googleBanner.style.display = 'none'; // Cache le ruban
            }
        }, 1000); // Délai de 1 seconde pour attendre le chargement complet du ruban
    }
